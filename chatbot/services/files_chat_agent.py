...
class FilesChatAgent:
    ...
    def retrieve(self, state: GraphState) -> Dict[str, Any]:
        ...
        """
        style_architecture = state["question"]
        documents = self.retriever.get_documents(style_architecture, int(settings.NUM_DOC))
        return {"documents": documents, "question": style_architecture}
    ...
    def generate(self, state: GraphState) -> Dict[str, Any]:
        ...
        generation = self.answer_generator.get_chain().invoke({"question": style_architecture, "context": context})
    ...
    def grade_documents(self, state: GraphState) -> Dict[str, Any]:
        ...
        filtered_docs = []
        for d in documents:
            score = self.document_grader.get_chain().invoke({"question": style_architecture, "document": d.page_content})
        ...
        return {"documents": filtered_docs, "question": style_architecture}
    ...
    def handle_no_answer(self, state: GraphState) -> Dict[str, Any]:
        ...
        """
        style_architecture = state["question"]
        generation = self.no_answer_handler.get_chain().invoke({"question": style_architecture})
        return {"generation": generation}
