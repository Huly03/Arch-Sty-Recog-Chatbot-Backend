...
class FilesChatAgent:
    ...
    def generate(self, state: GraphState) -> Dict[str, Any]:
        """
        Tạo câu trả lời dựa trên các tài liệu hoặc bài viết liên quan.
        ...
        # Tìm kiếm bài viết từ trang web
        retriever = Retriever(settings.LLM_NAME)
        articles = retriever.search_architecture_style(question)

        # Tạo câu trả lời từ các bài báo tìm được
        answer = "Các bài báo liên quan đến phong cách kiến trúc này:\n\n"
        for article in articles:
            answer += f"Title: {article['title']}\nLink: {article['link']}\n\n"
